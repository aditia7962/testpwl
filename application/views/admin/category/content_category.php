                ...
                <div class="panel-body">
					...
					<?php foreach($category as $value){?>
		     			<tr>
							...
							<td>
							<a href="<?php echo base_url('admin/category/update/').$value->category_id;?>"><button class="btn btn-warning"><i class="glyphicon glyphicon-pencil"></i></button></a>
							<a href="<?php echo base_url('admin/category/delete/').$value->category_id;?>"><button class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></button></a>
							</td>
		      			</tr>
		     		<?php }?>
						</tbody>
