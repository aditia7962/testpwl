    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url()?>">Office.com</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?=base_url('/customer/dashboard/')?>logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?=base_url().'customer/dashboard/'?>"><i class="fa fa-shopping-cart fa-fw"></i> Cart</a>
                        </li>
                        <li>
                            <a href="<?=base_url().'customer/dashboard/profile/'?>"><i class="fa fa-wrench fa-fw"></i>Setting</a>
                            <!-- /.nav-second-level -->
                        </li>
